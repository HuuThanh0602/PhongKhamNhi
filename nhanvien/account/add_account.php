...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $mat_khau = $_POST['mat_khau']; // Nhận mật khẩu từ form
    ...
    if ($checkStmt->rowCount() > 0) {
        ...
        $checkUsernameStmt = $conn->prepare("SELECT SoTaiKhoan, TenDangNhap, MaNhanVien FROM TaiKhoan WHERE SoTaiKhoan = :so_tai_khoan OR TenDangNhap = :ten_dang_nhap OR MaNhanVien = :ma_nhan_vien");
    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" name="mat_khau" class="form-control" required> <!-- Mật khẩu dưới dạng văn bản rõ ràng -->
            </div>
