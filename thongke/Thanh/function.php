...
<div class="container">
    ...
    <form method="GET" class="form-inline mb-3">
        ...
        <button type="submit" class="btn btn-primary">Tổng tiền xét nghiệm</button>
    </form>
    ...
    try {
        ...
        if ($maPhieuKham) {
            // Khai báo câu lệnh SQL để thực thi hàm
            $sql = "SELECT dbo.TienXetNghiem(:maPhieuKham) AS TongTienXetNghiem";
            ...
            // Kiểm tra và hiển thị tổng tiền xét nghiệm
            if ($result) {
                // Nếu TongTienXetNghiem là null, gán giá trị mặc định là 0
                $tongTienXetNghiem = $result['TongTienXetNghiem'] ?? 0;
                echo "<div class='alert alert-success' role='alert'>Tổng tiền xét nghiệm cho phiếu khám <strong>$maPhieuKham</strong> là: " . number_format($tongTienXetNghiem, 2) . " VND</div>";
            } else {
